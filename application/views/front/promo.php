        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title"><a href="front/promo" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i> View</a></h4>
            </div>
            <div class="card-body">
              <form action="front/promo/<?php echo $form ?>" method="POST" enctype="multipart/form-data" class="form-sample">                  
                <div class="row">
                  <div class="col-12">                
                    ...
                    <div class="form-group row">                                                              
                      <label class="col-sm-2 col-form-label-sm">Tgl Berlaku</label>
                      <div class="col-sm-4">                           
                        <input required type="date" <?php echo $read ?> value="<?php echo $tampil = ($row!='') ? $row->tgl_awal : "" ; ?>" name="tgl_awal" placeholder="Tgl Awal" class="form-control form-control-sm " />                        
                      </div>                   
                      <div class="col-sm-4">                           
                        <input required type="date" <?php echo $read ?> value="<?php echo $tampil = ($row!='') ? $row->tgl_akhir : "" ; ?>" name="tgl_akhir" placeholder="Tgl Akhir" class="form-control form-control-sm " />                        
                      </div>    
                    </div>               
                    <div class="form-group row">                                                              
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label-sm">Isi Promo</label>
                      <div class="col-sm-10">                        
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><a href="front/promo/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a></h4>
          </div>
          <div class="card-body">            
            <div class="box">                            
