      ...
      <?php                       
		...
		if($set=="insert"){
			if($mode == 'insert'){
				...
				$form = "update";              
				$vis  = "";
				$form_id = "<input type='hidden' name='id' value='$row->id_testimoni'>";              
			}
			?>
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title"><a href="front/testimoni" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i> View</a></h4>
            </div>
            <div class="card-body">
              <form action="front/testimoni/<?php echo $form ?>" method="POST" enctype="multipart/form-data" class="form-sample">                  
                <div class="row">
                  <div class="col-12">                
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">                    
                        <?=$form_id?>    
                        <input type="text" <?php echo $read ?> value="<?php echo $tampil = ($row!='') ? $row->nama : "" ; ?>" name="nama" placeholder="Nama" class="form-control form-control-sm " />
                      </div>                                          
                    </div>                                        
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label-sm">Angkatan/Jabatan/Tempat Bekerja</label>
                      <div class="col-sm-10">                        
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label-sm">Isi Testimoni</label>
                      <div class="col-sm-10">                        
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><a href="front/testimoni/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a></h4>
          </div>
          <div class="card-body">            
            <div class="box">                            
              <div class="table-responsive">
                <table id="testimoni_dt" class="table" style="width:100%">
                  <thead>
                    <tr>
                      <th width="5%">No</th>
                      <th>Alumni</th>                      
