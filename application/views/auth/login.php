...
<html lang="id-ID">
    ...
    <body>
        <h1>Login <?php echo get_store_name(); ?></h1>
        <div class=" w3l-login-form">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" name="username" value="<?php echo set_value('username', $old_username); ?>" class="form-control" placeholder="Username" required>
                </div>
